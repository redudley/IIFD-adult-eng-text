...
jqueryWidget: {
    _init: function () {
        ...
        this.continueMessage = dget(this.options, "continueMessage", "You have finished. You may return to Mechanical Turk.");
        ...
        this.obligatoryErrorGenerator =
            dget(this.options, "obligatoryErrorGenerator",
                 function (field) { return "The \u2018" + field + "\u2019 field is required."; });
        this.obligatoryCheckboxErrorGenerator =
            dget(this.options, "obligatoryCheckboxErrorGenerator",
                 function (field) { return "You have to check the" + field + "box to continue."; });
        this.obligatoryRadioErrorGenerator =
            dget(this.options, "obligatoryRadioErrorGenerator",
                 function (field) { return "You have to select an option for \u2018" + field + "\u2019."; });
